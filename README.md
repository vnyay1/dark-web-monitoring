...
│   │   ├── criticite.py          # criticité = sélecteurs distincts pondérés (FR-10)
...
Pour comprendre pourquoi une entrée a produit tant de sélecteurs (date retenue, coupure du texte,
